...
class UIHelper:
  ...
  def draw_piece(self, row, col, symbol):
    ...
    if (symbol == 'X'):
      pygame.draw.line(self.screen, self.BLACK, (x - self.SQUARE_SIZE // 3, y - self.SQUARE_SIZE // 3),
                       (x + self.SQUARE_SIZE // 3, y + self.SQUARE_SIZE // 3), 5)
      pygame.draw.line(self.screen, self.BLACK, (x - self.SQUARE_SIZE // 3, y + self.SQUARE_SIZE // 3),
                       (x + self.SQUARE_SIZE // 3, y - self.SQUARE_SIZE // 3), 5)
    else:
  ...
  def draw_button(self):
    ...
    self.button_rect = pygame.Rect((self.length - button_width) // 2, 0, button_width, button_height)
